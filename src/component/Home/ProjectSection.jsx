    ...
    <div>
      <div>
        ...
        <div className=' h-48 flex justify-around items-center sm:justify-center sm:gap-10 sm:mt-10'>
          <div className='flex sm:w-[200px] sm:h-[220px] items-center flex-col justify-center border p-4 rounded-sm bg-slate-100 shadow cursor-pointer hover:scale-95' style={{transition:"all .2s linear"}} onClick={() => { HandleProject("Javascript") }} id='javascipt'>
            <FaJs className='text-8xl text-violet-800' />
            <p className='font-medium text-gray-600'>Js Projects</p>
          </div>
          <div className='flex sm:w-[200px] sm:h-[220px] items-center border p-4 rounded-sm bg-slate-100 shadow cursor-pointer hover:scale-95 flex-col justify-center' style={{transition:"all .2s linear"}} onClick={() => { HandleProject("React") }} id='react'>
